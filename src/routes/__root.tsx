...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "Marc Martínez" },
      { property: "og:site_name", content: "Marc Martínez — Desarrollo Web" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Diseño y desarrollo webs modernas, rápidas y optimizadas para conversión para pymes y profesionales.",
          knowsAbout: [
            "Desarrollo web",
            "Diseño web",
            "React",
